...
function klasser(){
        ...
        btn1.graphics.drawRect(0,0,260,100);
        btn1.x = 30;
        btn1.y = 200;
        stage.addChild(btn1);
        ...
        btn2.graphics.drawRect(0,0,260,100);
        btn2.x = 320;
        btn2.y = 200;
        stage.addChild(btn2);
        ...
        btn3.graphics.drawRect(0,0,260,100);
        btn3.x = 610;
        btn3.y = 200;
        stage.addChild(btn3);
...
function pushedButton(emne, beskrivelse, links){
     ...
     $('#wrapper2').append('<div class="border-popup" /*style="height:100px; width:100px*/"><p>'+ emne +'</p></div>');
     $('#wrapper2').append('<div class="border-popup"><p>'+ beskrivelse +'</p></div>');     
     $('#wrapper2').append('<div class="border-popup"><p>'+ links +'</p></div>');  
