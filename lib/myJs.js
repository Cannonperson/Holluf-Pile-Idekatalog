    ...
    for(var i = 0; i < data.classes.length; i++){
        ...
        for(var i2 = 0; i2 < data.classes[i].emner.length; i2++){
            if(i2 == 0 || data.classes[i].emner[i2 - 1].overEmne != data.classes[i].emner[i2].overEmne){
                $('#class'+i).append('<h3>' + data.classes[i].emner[i2].overEmne + '</h3><div id="overEmne'+overEmneIndex+'" class="accordion"></div>');
                overEmneIndex++;
            }
            $('#overEmne'+overEmneIndex).append('<h3>' + data.classes[i].emner[i2].emneOverskrift +'</h3><div><button class="reset" id="emne'+i +''+i2+'">' + data.classes[i].emner[i2].emneOverskrift +'</button></div>');
